...
export default function GetInTouch() {
  return (
    <div id="contact" className=" flex flex-col justify-center items-center p-8 md:w-[90%] md:m-auto ">
      {/* Contact */}
      <div className="w-full flex flex-col justify-center items-center p-2 ">
        <p className="text-color contact">CONTACT</p>
        <h2 className="text-3xl font-semibold contact">Get In Touch</h2>
        <div className="w-full bg-background text-foreground p-4 md:p-10 rounded-lg mt-10 border-2 border-gray-500 border-dashed">
          ...
          <div className="flex flex-wrap items-center gap-3 conBtn">
            ...
            >
              <Button
                className="border-1 bg-violet-500 dark:border-gray-600 mt-2 md:mt-4 cursor-pointer transition duration-500"
                variant={"default"}
              >
                <Mail />
                Email Me

...
const SheetDemo = () => {
  ...
  return (
    <div className=" fixed text-end text-white flex justify-between items-center p-3 top-0 z-11 bg-gray-900 w-full border-b border-gray-700">
      ...
      <div className="md:hidden">
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <Menu
              className="opacity-80 hover:opacity-100 hover:text-white transition duration-300 cursor-pointer"
              onClick={() => setOpen(true)}
            />
          </SheetTrigger>
          <SheetContent className="bg-gray-950 text-white w-[90%] md:w-[50%] border-none">
            <SheetHeader>
